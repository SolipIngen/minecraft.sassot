...
public class BambooSpearEntityRenderer extends EntityRenderer<BambooSpearEntity> {
    public static final Identifier TEXTURE = Identifier.of(SpearsAxesSwordsShieldsAndOtherTools.MOD_ID, "textures/entity/spear/bamboo_spear.png");
    ...
    @Override
    public void render(BambooSpearEntity spearEntity, float f, float g, MatrixStack matrixStack, VertexConsumerProvider vertexConsumerProvider, int i) {
        matrixStack.push();
    ...
    @Override
    public Identifier getTexture(BambooSpearEntity spearEntity) {
        return TEXTURE;
    }
