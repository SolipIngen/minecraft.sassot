...
public class WoodenSpearEntityRenderer extends EntityRenderer<WoodenSpearEntity> {
    public static final Identifier TEXTURE = Identifier.of(SpearsAxesSwordsShieldsAndOtherTools.MOD_ID, "textures/entity/spear/wooden_spear.png");
    ...
    @Override
    public void render(WoodenSpearEntity spearEntity, float f, float g, MatrixStack matrixStack, VertexConsumerProvider vertexConsumerProvider, int i) {
        matrixStack.push();
    ...
    @Override
    public Identifier getTexture(WoodenSpearEntity spearEntity) {
        return TEXTURE;
    }
