...
public class DiamondSpearEntityRenderer extends EntityRenderer<DiamondSpearEntity> {
    public static final Identifier TEXTURE = Identifier.of(SpearsAxesSwordsShieldsAndOtherTools.MOD_ID, "textures/entity/spear/diamond_spear.png");
    ...
    @Override
    public void render(DiamondSpearEntity spearEntity, float f, float g, MatrixStack matrixStack, VertexConsumerProvider vertexConsumerProvider, int i) {
        matrixStack.push();
    ...
    @Override
    public Identifier getTexture(DiamondSpearEntity spearEntity) {
        return TEXTURE;
    }
}
