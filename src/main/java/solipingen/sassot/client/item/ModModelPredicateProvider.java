...
public class ModModelPredicateProvider {
    ...
    private static void registerShield(Item shield) {
        ...
        ModelPredicateProviderRegistry.register(shield, new Identifier(SpearsAxesSwordsShieldsAndOtherTools.MOD_ID, "cloaking"),
    ...
    private static void registerFishingRod(Item fishingRod) {
        ModelPredicateProviderRegistry.register(fishingRod, new Identifier("cast"), 
