...
public class ModEntityModelLayers {
    ...
    public static final EntityModelLayer STONE_SPEAR_ENTITY_MODEL_LAYER = new EntityModelLayer(new Identifier(SpearsAxesSwordsShieldsAndOtherTools.MOD_ID, "stone_spear"), "main");
    public static final EntityModelLayer FLINT_SPEAR_ENTITY_MODEL_LAYER = new EntityModelLayer(new Identifier(SpearsAxesSwordsShieldsAndOtherTools.MOD_ID, "flint_spear"), "main");
    public static final EntityModelLayer COPPER_SPEAR_ENTITY_MODEL_LAYER = new EntityModelLayer(new Identifier(SpearsAxesSwordsShieldsAndOtherTools.MOD_ID, "copper_spear"), "main");
    public static final EntityModelLayer GOLDEN_SPEAR_ENTITY_MODEL_LAYER = new EntityModelLayer(new Identifier(SpearsAxesSwordsShieldsAndOtherTools.MOD_ID, "golden_spear"), "main");
    public static final EntityModelLayer IRON_SPEAR_ENTITY_MODEL_LAYER = new EntityModelLayer(new Identifier(SpearsAxesSwordsShieldsAndOtherTools.MOD_ID, "iron_spear"), "main");
    public static final EntityModelLayer DIAMOND_SPEAR_ENTITY_MODEL_LAYER = new EntityModelLayer(new Identifier(SpearsAxesSwordsShieldsAndOtherTools.MOD_ID, "diamond_spear"), "main");
    public static final EntityModelLayer NETHERITE_SPEAR_ENTITY_MODEL_LAYER = new EntityModelLayer(new Identifier(SpearsAxesSwordsShieldsAndOtherTools.MOD_ID, "netherite_spear"), "main");
    public static final EntityModelLayer BLAZEARM_ENTITY_MODEL_LAYER = new EntityModelLayer(new Identifier(SpearsAxesSwordsShieldsAndOtherTools.MOD_ID, "blazearm"), "main");
