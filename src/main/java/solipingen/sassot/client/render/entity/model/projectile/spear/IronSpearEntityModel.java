...
public class IronSpearEntityModel extends EntityModel<IronSpearEntity> {
	...
	@Override
	public void setAngles(IronSpearEntity entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
	}
