...
public class DiamondSpearEntityModel extends EntityModel<DiamondSpearEntity> {
	...
	@Override
	public void setAngles(DiamondSpearEntity entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
	}
