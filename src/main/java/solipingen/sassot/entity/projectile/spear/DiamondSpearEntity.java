...
public class DiamondSpearEntity extends SpearEntity {
    ...
    private static final ItemStack DEFAULT_STACK = new ItemStack(ModItems.DIAMOND_SPEAR);
    ...
    public DiamondSpearEntity(World world, double x, double y, double z, ItemStack stack) {
        super(ModEntityTypes.DIAMOND_SPEAR_ENTITY, world, x, y, z, DAMAGE_AMOUNT, SPEED, stack);
    }
