...
public abstract class SpearEntity extends PersistentProjectileEntity {
    ...
    @Nullable private Entity skeweredEntity;


    public SpearEntity(EntityType<? extends SpearEntity> entityType, float damageAmount, float launchSpeed, ItemStack stack, World world) {
        super(entityType, world, stack);
        this.damageAmount = damageAmount;
        this.launchSpeed = launchSpeed;
        this.skeweredEntity = null;
    }
    ...
    public SpearEntity(EntityType<? extends SpearEntity> entityType, LivingEntity owner, float damageAmount, float launchSpeed, ItemStack stack, World world) {
        ...
        this.dataTracker.set(LOYALTY, (byte)EnchantmentHelper.getLevel(Enchantments.LOYALTY, this.getItemStack()));
        this.dataTracker.set(SKEWERING, (byte)EnchantmentHelper.getLevel(ModEnchantments.SKEWERING, this.getItemStack()));
        this.dataTracker.set(GROUNDSHAKING, (byte)EnchantmentHelper.getLevel(ModEnchantments.GROUNDSHAKING, this.getItemStack()));
        this.dataTracker.set(ENCHANTED, this.getItemStack().hasGlint());
        this.skeweredEntity = null;
    }

    public SpearEntity(EntityType<? extends SpearEntity> entityType, World world, double x, double y, double z, float damageAmount, float launchSpeed, ItemStack stack) {
