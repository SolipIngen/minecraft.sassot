...
public class GoldenSpearEntity extends SpearEntity {
    ...
    public GoldenSpearEntity(World world, double x, double y, double z, ItemStack stack) {
        super(ModEntityTypes.GOLDEN_SPEAR_ENTITY, world, x, y, z, DAMAGE_AMOUNT, SPEED, stack);
    }
