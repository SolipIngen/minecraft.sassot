...
public class BlazearmEntity extends PersistentProjectileEntity {
    ...
    public void tick() {
        ...
        if (!this.isTouchingWater()) {
            world.addParticle(ParticleTypes.FLAME, this.getParticleX(1.0), this.getRandomBodyY(), this.getParticleZ(1.0), 0.6*(this.random.nextDouble() - 0.5) + this.getVelocity().x, 0.6*(this.random.nextDouble() - 0.5) + this.getVelocity().y, 0.6*(this.random.nextDouble() - 0.5) + this.getVelocity().z);
        }
    }
