...
public class ModVillagerProfessions {
    ...
    protected static ScheduleBuilder registerSchedule(String id) {
        Schedule schedule = Registry.register(Registries.SCHEDULE, new Identifier(SpearsAxesSwordsShieldsAndOtherTools.MOD_ID, id), new Schedule());
    ...
    public static class ProcessAndEnchantItemFactory implements Factory {
        ...
        public TradeOffer create(Entity entity, Random random) {
            ...
            ItemStack itemStack = EnchantmentHelper.enchant(entity.getWorld().getEnabledFeatures(), random, new ItemStack(this.processed.getItem()), i, false);
