...
public class FishingRodFusionTemplateItem extends SmithingTemplateItem {
    ...
    private static final Text FISHING_ROD_FUSION_TEXT = Text.translatable(Util.createTranslationKey("upgrade", Identifier.of(SpearsAxesSwordsShieldsAndOtherTools.MOD_ID, "fishing_rod_fusion"))).formatted(TITLE_FORMATTING);
    private static final Text FISHING_ROD_FUSION_APPLIES_TO_TEXT = Text.translatable(Util.createTranslationKey("item", Identifier.of(SpearsAxesSwordsShieldsAndOtherTools.MOD_ID,"smithing_template.fishing_rod_fusion.applies_to"))).formatted(DESCRIPTION_FORMATTING);
    private static final Text FISHING_ROD_FUSION_INGREDIENTS_TEXT = Text.translatable(Util.createTranslationKey("item", Identifier.of(SpearsAxesSwordsShieldsAndOtherTools.MOD_ID,"smithing_template.fishing_rod_fusion.ingredients"))).formatted(DESCRIPTION_FORMATTING);
    private static final Text FISHING_ROD_FUSION_BASE_SLOT_DESCRIPTION_TEXT = Text.translatable(Util.createTranslationKey("item", Identifier.of(SpearsAxesSwordsShieldsAndOtherTools.MOD_ID,"smithing_template.fishing_rod_fusion.base_slot_description")));
    private static final Text FISHING_ROD_FUSION_ADDITIONS_SLOT_DESCRIPTION_TEXT = Text.translatable(Util.createTranslationKey("item", Identifier.of(SpearsAxesSwordsShieldsAndOtherTools.MOD_ID,"smithing_template.fishing_rod_fusion.additions_slot_description")));
    private static final Identifier EMPTY_SLOT_FISHING_ROD_TEXTURE = Identifier.of(SpearsAxesSwordsShieldsAndOtherTools.MOD_ID, "item/empty_slot_fishing_rod");
