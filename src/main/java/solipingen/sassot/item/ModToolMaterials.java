...
public enum ModToolMaterials implements ToolMaterial {
    COPPER(ModBlockTags.INCORRECT_FOR_COPPER_TOOL, 250, 6.0f, 2.0f, 14, () -> Ingredient.ofItems(Items.COPPER_INGOT)),
    EMERALD(ModBlockTags.INCORRECT_FOR_EMERALD_TOOL, 420, 4.0f, 2.0f, 15, () -> Ingredient.ofItems(Items.EMERALD));
