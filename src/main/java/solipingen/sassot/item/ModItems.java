...
public class ModItems {
    ...
    public static final Item WOODEN_SPEAR = ModItems.registerItem("wooden_spear", 
        new SpearItem(ToolMaterials.WOOD, new Item.Settings().attributeModifiers(SpearItem.createAttributeModifiers(ToolMaterials.WOOD, 4.0f, -2.3f))));
    
    public static final Item BAMBOO_SPEAR = ModItems.registerItem("bamboo_spear", 
        new SpearItem(ToolMaterials.WOOD, new Item.Settings().attributeModifiers(SpearItem.createAttributeModifiers(ToolMaterials.WOOD, 4.0f, -2.2f))));
    
    public static final Item STONE_SPEAR = ModItems.registerItem("stone_spear", 
        new SpearItem(ToolMaterials.STONE, new Item.Settings().attributeModifiers(SpearItem.createAttributeModifiers(ToolMaterials.STONE, 4.0f, -2.8f))));
    
    public static final Item FLINT_SPEAR = ModItems.registerItem("flint_spear", 
        new SpearItem(ToolMaterials.STONE, new Item.Settings().attributeModifiers(SpearItem.createAttributeModifiers(ToolMaterials.STONE, 4.0f, -2.5f))));
    
    public static final Item COPPER_SPEAR = ModItems.registerItem("copper_spear", 
        new SpearItem(ModToolMaterials.COPPER, new Item.Settings().attributeModifiers(SpearItem.createAttributeModifiers(ModToolMaterials.COPPER, 5.0f, -2.6f))));
    
    public static final Item GOLDEN_SPEAR = ModItems.registerItem("golden_spear", 
        new SpearItem(ToolMaterials.GOLD, new Item.Settings().attributeModifiers(SpearItem.createAttributeModifiers(ToolMaterials.GOLD, 6.0f, -2.6f))));

    public static final Item IRON_SPEAR = ModItems.registerItem("iron_spear", 
        new SpearItem(ToolMaterials.IRON, new Item.Settings().attributeModifiers(SpearItem.createAttributeModifiers(ToolMaterials.IRON, 6.0f, -2.5f))));

    public static final Item DIAMOND_SPEAR = ModItems.registerItem("diamond_spear", 
        new SpearItem(ToolMaterials.DIAMOND, new Item.Settings().attributeModifiers(SpearItem.createAttributeModifiers(ToolMaterials.DIAMOND, 7.0f, -2.3f))));
    
    public static final Item NETHERITE_SPEAR = ModItems.registerItem("netherite_spear", 
        new SpearItem(ToolMaterials.NETHERITE, new Item.Settings().attributeModifiers(SpearItem.createAttributeModifiers(ToolMaterials.NETHERITE, 7.0f, -2.2f)).fireproof()));

    public static final Item BLAZEARM = ModItems.registerItem("blazearm", 
        new BlazearmItem(new Item.Settings().attributeModifiers(BlazearmItem.createAttributeModifiers()).fireproof().maxDamage(1808)));
    ...
    public static final Item IRON_FRAMED_WOODEN_SHIELD = ModItems.registerItem("iron_framed_wooden_shield", 
        new ModShieldItem(ToolMaterials.IRON, 4.0f, true, 60, 0.05f, new Item.Settings()));

    public static final Item DIAMOND_FRAMED_WOODEN_SHIELD = ModItems.registerItem("diamond_framed_wooden_shield", 
        new ModShieldItem(ToolMaterials.DIAMOND, 5.0f, true, 60, 0.05f, new Item.Settings()));

    public static final Item EMERALD_FRAMED_WOODEN_SHIELD = ModItems.registerItem("emerald_framed_wooden_shield", 
        new ModShieldItem(ModToolMaterials.EMERALD, 4.0f, true, 60, 0.05f, new Item.Settings()));

    public static final Item NETHERITE_FRAMED_WOODEN_SHIELD = ModItems.registerItem("netherite_framed_wooden_shield", 
        new ModShieldItem(ToolMaterials.NETHERITE, 5.0f, true, 60, 0.05f, new Item.Settings()));
    
    public static final Item COPPER_SHIELD = ModItems.registerItem("copper_shield", 
        new ModShieldItem(ModToolMaterials.COPPER, 6.0f, false, 80, 0.075f, new Item.Settings()));
    
    public static final Item GOLDEN_SHIELD = ModItems.registerItem("golden_shield", 
        new ModShieldItem(ToolMaterials.GOLD, 6.0f, false, 80, 0.075f, new Item.Settings()));
    
    public static final Item IRON_SHIELD = ModItems.registerItem("iron_shield", 
        new ModShieldItem(ToolMaterials.IRON, 7.0f, false, 100, 0.1f, new Item.Settings()));
    
    public static final Item DIAMOND_SHIELD = ModItems.registerItem("diamond_shield", 
        new ModShieldItem(ToolMaterials.DIAMOND, 9.0f, false, 120, 0.15f, new Item.Settings()));
    
    public static final Item NETHERITE_SHIELD = ModItems.registerItem("netherite_shield", 
        new ModShieldItem(ToolMaterials.NETHERITE, 10.0f, false, 140, 0.175f, new Item.Settings().fireproof()));
    ...
    public static final Item CARROT_ON_A_COPPER_FUSED_STICK = ModItems.registerItem("carrot_on_a_copper_fused_stick", 
        (Item)new ModOnAStickItem<PigEntity>(new Item.Settings().maxDamage(25), EntityType.PIG, ModToolMaterials.COPPER, 7));
    ...
    public static final Item WARPED_FUNGUS_ON_A_COPPER_FUSED_STICK = ModItems.registerItem("warped_fungus_on_a_copper_fused_stick", 
        (Item)new ModOnAStickItem<StriderEntity>(new Item.Settings().maxDamage(100), EntityType.STRIDER, ModToolMaterials.COPPER, 1));

    public static final Item CARROT_ON_AN_IRON_FUSED_STICK = ModItems.registerItem("carrot_on_an_iron_fused_stick", 
        (Item)new ModOnAStickItem<PigEntity>(new Item.Settings().maxDamage(25), EntityType.PIG, ToolMaterials.IRON, 7));
        
    public static final Item WARPED_FUNGUS_ON_AN_IRON_FUSED_STICK = ModItems.registerItem("warped_fungus_on_an_iron_fused_stick", 
        (Item)new ModOnAStickItem<StriderEntity>(new Item.Settings().maxDamage(100), EntityType.STRIDER, ToolMaterials.IRON, 1));

    public static final Item CARROT_ON_A_GOLD_FUSED_STICK = ModItems.registerItem("carrot_on_a_gold_fused_stick", 
        (Item)new ModOnAStickItem<PigEntity>(new Item.Settings().maxDamage(25), EntityType.PIG, ToolMaterials.GOLD, 7));
        
    public static final Item WARPED_FUNGUS_ON_A_GOLD_FUSED_STICK = ModItems.registerItem("warped_fungus_on_a_gold_fused_stick", 
        (Item)new ModOnAStickItem<StriderEntity>(new Item.Settings().maxDamage(100), EntityType.STRIDER, ToolMaterials.GOLD, 1));

    public static final Item CARROT_ON_A_DIAMOND_FUSED_STICK = ModItems.registerItem("carrot_on_a_diamond_fused_stick", 
        (Item)new ModOnAStickItem<PigEntity>(new Item.Settings().maxDamage(25), EntityType.PIG, ToolMaterials.DIAMOND, 7));
    ...
    public static final Item WARPED_FUNGUS_ON_A_DIAMOND_FUSED_STICK = ModItems.registerItem("warped_fungus_on_a_diamond_fused_stick", 
        (Item)new ModOnAStickItem<StriderEntity>(new Item.Settings().maxDamage(100), EntityType.STRIDER, ToolMaterials.DIAMOND, 1));

    public static final Item CARROT_ON_A_NETHERITE_FUSED_STICK = ModItems.registerItem("carrot_on_a_netherite_fused_stick", 
        (Item)new ModOnAStickItem<PigEntity>(new Item.Settings().maxDamage(25).fireproof(), EntityType.PIG, ToolMaterials.NETHERITE, 7));
    ...
    public static final Item WARPED_FUNGUS_ON_A_NETHERITE_FUSED_STICK = ModItems.registerItem("warped_fungus_on_a_netherite_fused_stick", 
        (Item)new ModOnAStickItem<StriderEntity>(new Item.Settings().maxDamage(100).fireproof(), EntityType.STRIDER, ToolMaterials.NETHERITE, 1));
    ...
    public static final Item ELDER_GUARDIAN_SPIKE_SHARD = ModItems.registerItem("elder_guardian_spike_shard", 
        new ElderGuardianSpikeShardItem(1, -1.0f, new Item.Settings().attributeModifiers(ElderGuardianSpikeShardItem.createAttributeModifiers()).maxDamage(104)));
