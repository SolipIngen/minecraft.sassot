...
public class ModDataPacks {
    ...
    public static void registerModDataPacks() {
        ...
        FabricLoader.getInstance().getModContainer(SpearsAxesSwordsShieldsAndOtherTools.MOD_ID).ifPresent((container) -> {
            ResourceManagerHelper.registerBuiltinResourcePack(new Identifier(SpearsAxesSwordsShieldsAndOtherTools.MOD_ID, "bettersassotcombat"), container, ResourcePackActivationType.DEFAULT_ENABLED);
        });
